...
which are not included in the official \pkg{RKWard} releases. Technical details on the definition of plugins,
...
is available. The \proglang{R} script and data for automatic demonstration can be found in the accompanying zipped file ``examples.zip''.
